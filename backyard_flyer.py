...
class BackyardFlyer(Drone):
    ...
    def __init__(self, connection):
        ...
        # Keep a constant heading
        self.HEADING = 0

        # Close enough to goal in meters
        self.CLOSE_ENOUGH_METERS = 0.1
    ...
    def is_close_enough(self, current, goal):
        return abs(current - goal) < self.CLOSE_ENOUGH_METERS

    def is_close_enough_to_waypoint(self):
        for i in range(2):
            if not self.is_close_enough(self.local_position[i], self.target_position[i]):
                return False
        return True
    ...
    def local_position_callback(self):
        ...
        if self.flight_state == States.TAKEOFF:
            ...
            if self.is_close_enough(altitude, self.target_position[2]):
                self.waypoint_transition()
        elif self.flight_state == States.WAYPOINT:
            if self.is_close_enough_to_waypoint():
    ...
    def takeoff_transition(self):
        ...
        print("Goal is altitude of: ", target_altitude)
